...
if __name__ == '__main__':
    ...
    txnDfNoColNames = txn_fact_rdd.toDF()
    txnDfNoColNames.printSchema()
    txnDfNoColNames.show(5)

    txnDfNoColNames2 = spark.createDataFrame(txn_fact_rdd)
    txnDfNoColNames2.printSchema()
    txnDfNoColNames2.show(5, False)

    txnDfWithColNames = txn_fact_rdd.toDF(['txn_id', 'create_time', 'amount', "cust_id", "status", "merchant_id", "created_time_ist"])
